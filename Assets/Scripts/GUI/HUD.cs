	...
	public string GetCellInfo(CellInfo.CellInfoType cellInfoType)
	{
		switch (cellInfoType)
		{
			case CellInfo.CellInfoType.Global:
				return CellInfo.GetCellInfoGlobal(ActiveTemperatureUnits, Sim.InverseCellCount, ref Sim.WorldData, ref Sim.ActiveSimState, ref Sim.TempState, ref Sim.DisplayState);
			case CellInfo.CellInfoType.Enthalpy:
				return CellInfo.GetCellInfoEnthalpy(ActiveTemperatureUnits, Sim.InverseCellCount, ref Sim.WorldData, ref Sim.ActiveSimState, ref Sim.TempState, ref Sim.DisplayState);
			case CellInfo.CellInfoType.Energy:
				return CellInfo.GetCellInfoEnergy(ActiveTemperatureUnits, Sim.InverseCellCount, ref Sim.WorldData, ref Sim.ActiveSimState, ref Sim.TempState, ref Sim.DisplayState);
			case CellInfo.CellInfoType.Cell:
				return CellInfo.GetCellInfoCell(ActiveTemperatureUnits, Gameplay.ActiveCellIndex, ref Sim.StaticState, ref Sim.ActiveSimState, ref Sim.TempState, ref Sim.DisplayState);
			case CellInfo.CellInfoType.Atmosphere:
				return CellInfo.GetCellInfoAtmosphere(ActiveTemperatureUnits, Gameplay.ActiveCellIndex, ref Sim.WorldData, ref Sim.ActiveSimState, ref Sim.TempState, ref Sim.StaticState, ref Sim.DisplayState);
			...
			case CellInfo.CellInfoType.Water:
				return CellInfo.GetCellInfoWater(ActiveTemperatureUnits, Gameplay.ActiveCellIndex, ref Sim.WorldData, ref Sim.ActiveSimState, ref Sim.TempState, ref Sim.StaticState, ref Sim.DisplayState);
		}
		return "";
	}
